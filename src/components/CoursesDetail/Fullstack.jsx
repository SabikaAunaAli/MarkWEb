...
<p className='text-3xl font-normal'>Full Stack Web Development with React Hooks and Redux</p>
...
<div className='flex align-middle justify-self-start border-2 border-gray-200 rounded-md p-4'>
   ...
   <a href="https://websitedemos.net/online-coding-course-02/lessons/install-and-setup/" className='px-4  text-xl font-normal text-gray-600  hover:text-blue-400'>Install and Setup React</a>
    </div>


    <div className='flex align-middle justify-self-start border-2 border-gray-200 rounded-md p-4 my-4 '>
   <p className='pl-3 py-1 text-gray-300 text-2xl font-bold'><FaRegCircle /> </p>
   <a href="https://websitedemos.net/online-coding-course-02/lessons/python-basic/" className='px-4  text-xl font-normal text-gray-600 hover:text-blue-400'>React Native for Mobile</a>
    </div>


    <div className='flex align-middle justify-self-start border-2 border-gray-200 rounded-md p-4 '>
   <p className='pl-3 py-1 text-gray-300 text-2xl font-bold'><FaRegCircle /> </p>
   <a href="https://websitedemos.net/online-coding-course-02/lessons/python-advanced/" className='px-4  text-xl font-normal text-gray-600  hover:text-blue-400'>Health Tracking App</a>
    </div>
